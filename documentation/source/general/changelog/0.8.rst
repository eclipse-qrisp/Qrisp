...
The BlockEncoding class is the central abstraction for Quantum Linear Algebra in Qrisp. By establishing block encodings as the main programming abstractions, it allows users to program complex quantum linear algebra as easily as handling arrays in NumPy. It seamlessly embeds a non-unitary operator into the upper-left block of a larger unitary system.  With this intuitive interface, users can write clean matrix expressions while Qrisp's compiler automatically handles the heavy lifting of underlying circuit construction and ancilla management.
...
For a hands-on introduction, check out the BlockEncoding tutorials: :ref:`BlockEncoding class 101 <BE101>`, and :ref:`BlockEncoding class 201 <BE201>`.
