...
ax1.plot(
    node_count[: len(qri04_gc)], qri04_gc, c="#20306f", marker="o", linestyle="solid", linewidth=3, label="Qrisp 0.4"
)
...
ax2.plot(
    node_count[: len(qri04_compiletime)],
    qri04_compiletime,
    c="#20306f",
    marker="o",
    linestyle="solid",
...
ax2.plot(
    node_count[: len(qri_compiletime)],
    qri_compiletime,
    c="#7d7d7d",
    marker="o",
    linestyle="solid",
...
ax2.plot(
    node_count[: len(qis_compiletime)],
    qis_compiletime,
    c="#6929C4",
    marker="o",
    linestyle="solid",
