...
- **Flattened block-encoding arithmetic**
  ...
  and use a qubit-efficient construction by default: factor ancillas share a
  workspace sized to the largest factor, while a logarithmic shift register
  separates garbage generated by successive factors. The previous
