...
Since :ref:`QuantumSession` is an inheritor of QuantumCircuit, it also exposes an append method, implying that once a QuantumCircuit is created it can be smoothly integrated into Qrisp's high-level infrastructure using the :meth:`to_gate <qrisp.QuantumCircuit.to_gate>` method:
...
There are 6 important classes here:
