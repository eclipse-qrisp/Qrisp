...
You think that there is something that Qrisp is desperately missing and somebody should work on that? Request a feature! 

You can do that by going to the `open issues on GitHub <https://github.com/eclipse-qrisp/Qrisp/issues>`_ tab, creating a new issue and tagging it as a **feature request**. Thank you for sharing your idea!