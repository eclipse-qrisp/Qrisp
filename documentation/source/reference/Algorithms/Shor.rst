...
Qrisp provides a dead simple interface to integer factorization using your own backend. For details how this algorithm is implemented, please check the :ref:`Shor tutorial <shor_tutorial>`.
