...
Ideally we want you to keep all your Qrisp code the same and simply enable the Jasp feature. A large fraction of code written for static mode works in dynamic mode without any changes — see the :doc:`Static vs. Dynamic Mode <Static_vs_Dynamic>` page for the patterns that do and don't carry over. So if you simply want to speed up your code, you can stop reading here. Otherwise get ready for more background knowledge (yay)!
