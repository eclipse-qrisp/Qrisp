...
"""Tests for the convert_to_prx circuit pass in qrisp.circuit.pass_management.passes.convert_to_prx."""
        ...
        for _ in range(25):
            ...
            for instr in result.data:
                ...
                if op.num_qubits == 1 and op.num_clbits == 0:
                    assert isinstance(op, PRXGate) or op.name == "gphase", f"Non-PRX single-qubit gate: {op.name}"
