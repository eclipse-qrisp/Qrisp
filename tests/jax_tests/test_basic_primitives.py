...
def test_basic_primitives():
    ...
    print(make_jaspr(test_function)(2.0))
    compare_jaxpr(
        make_jaspr(test_function)(2.0),
        [
            "jasp.create_qubits",
            "jasp.get_qubit",
            "jasp.quantum_gate",
...
def test_make_jaxpr_mod():
    ...
    jaxpr, out_tree = make_jaxpr_mod(
        static_func, static_argnums=(1,), return_shape=True
    )(2.0, 3)
