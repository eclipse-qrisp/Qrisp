...
def test_to_qc_inside_make_jaspr_with_measurements():
    ...
    def outer_func():
        ...
        assert isinstance(returned_clbit, Clbit), f"Expected Clbit, got {type(returned_clbit)}"
...
def test_to_qc_stim_conversion_inside_tracing():
    ...
    def outer_func():
        ...
        assert stim_circ.num_measurements == 2, f"Expected 2 measurements, got {stim_circ.num_measurements}"
