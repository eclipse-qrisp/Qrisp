...
class TestFoldScalarLinalgGeneric:
    ...
    @pytest.mark.parametrize("is_0d, num_outputs, reason", [
...
class TestCmpiExtUIFolding:
    ...
    @pytest.mark.parametrize("pred_int, rhs_val, expected_result", [
        # ======= vs 0 =======
        (0, 0, "NOT"),       # eq  0 → NOT %x
        (1, 0, "IDENTITY"),  # ne  0 → %x
    ...
    @pytest.mark.parametrize("pred_int, rhs_val, lhs_is_extui, reason", [
