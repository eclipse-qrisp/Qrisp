...
"""Tests cyclic_shift on QuantumArray with fixed and quantum-controlled shift amounts."""
...
def test_cycling_function():
    ...
    assert qa.get_measurement() == {
        OutcomeArray([7, 0, 1, 2, 3, 4, 5, 6]): 0.3333333333333333,
        OutcomeArray([4, 5, 6, 7, 0, 1, 2, 3]): 0.3333333333333333,
        OutcomeArray([0, 1, 2, 3, 4, 5, 6, 7]): 0.3333333333333333,
    }
