...
"""Tests conversion of QuantumCircuit to Stim circuits, including noise, detectors, and observables."""
...
def test_qc_parity_method_observable_map():
    ...
    stim_circuit, meas_map, det_map, obs_map = qc.to_stim(
        return_measurement_map=True, return_detector_map=True, return_observable_map=True
    )
