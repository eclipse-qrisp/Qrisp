...
"""Tests the conjugate environment using a QFT-based Fourier adder, including controlled versions."""

import numpy as np

from qrisp import QFT, PTControlledOperation, QuantumFloat, conjugate, control, p
