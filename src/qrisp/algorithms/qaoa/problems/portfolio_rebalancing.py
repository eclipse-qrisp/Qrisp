...
"""Implements the QAOA cost operator, cost function, and state prep for discrete portfolio rebalancing."""
...
def portfolio_init(lots):
    """| Initial state for the discrete portfolio rebalancing problem, as described in https://arxiv.org/abs/1904.07358.
        | Depending on the number of lots a QuantumArray is prepared, where the first index
        describes the short positions held and the second index describes the long positions held.
