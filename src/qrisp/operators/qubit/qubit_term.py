...
PAULI_TABLE = {("I","I"):("I",1),("I","X"):("X",1),("I","Y"):("Y",1),("I","Z"):("Z",1),("I","A"):("A",1),("I","C"):("C",1),("I","P0"):("P0",1),("I","P1"):("P1",1),("X","I"):("X",1),("X","X"):("I",1),("X","Y"):("Z",1j),("X","Z"):("Y",(-0-1j)),("X","A"):("P1",1),("X","C"):("P0",1),("X","P0"):("C",1),("X","P1"):("A",1),("Y","I"):("Y",1),("Y","X"):("Z",(-0-1j)),("Y","Y"):("I",1),("Y","Z"):("X",1j),("Y","A"):("P1",1j),("Y","C"):("P0",(-0-1j)),("Y","P0"):("C",1j),("Y","P1"):("A",(-0-1j)),("Z","I"):("Z",1),("Z","X"):("Y",1j),("Z","Y"):("X",(-0-1j)),("Z","Z"):("I",1),("Z","A"):("A",1),("Z","C"):("C",-1),("Z","P0"):("P0",1),("Z","P1"):("P1",-1),("A","I"):("A",1),("A","X"):("P0",1),("A","Y"):("P0",1j),("A","Z"):("A",-1),("A","A"):("I",0),("A","C"):("P0",1),("A","P0"):("I",0),("A","P1"):("A",1),("C","I"):("C",1),("C","X"):("P1",1),("C","Y"):("P1",(-0-1j)),("C","Z"):("C",1),("C","A"):("P1",1),("C","C"):("I",0),("C","P0"):("C",1),("C","P1"):("I",0),("P0","I"):("P0",1),("P0","X"):("A",1),("P0","Y"):("A",(-0-1j)),("P0","Z"):("P0",1),("P0","A"):("A",1),("P0","C"):("I",0),("P0","P0"):("P0",1),("P0","P1"):("I",0),("P1","I"):("P1",1),("P1","X"):("C",1),("P1","Y"):("C",1j),("P1","Z"):("P1",-1),("P1","A"):("I",0),("P1","C"):("C",1),("P1","P0"):("I",0),("P1","P1"):("P1",1)}
