...
The main entry point is :func:`jaspr_to_quake_mlir`, which lowers a
:class:`~qrisp.jasp.Jaspr` all the way from the generic Jasp xDSL dialect
(see :mod:`qrisp.jasp.mlir`) down to the CUDA-Q Quake and CC dialects.
...
jaspr_to_quake
    Pipeline entry-point (:func:`jaspr_to_quake_mlir`), orchestrating passes 1-5.
"""
