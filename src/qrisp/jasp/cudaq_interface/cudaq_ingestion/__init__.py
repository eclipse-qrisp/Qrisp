...
This package picks up where :mod:`qrisp.jasp.cudaq_interface.quake_lowering`
...
xdsl_ingestion
    ...
    into a native :class:`~cudaq.kernel.kernel_decorator.PyKernelDecorator`
    via :func:`cudaq_kernel_from_xdsl_module`.
"""
