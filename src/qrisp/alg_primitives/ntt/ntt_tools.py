...
"""Tools for performing the Number Theoretic Transform (NTT) and its quantum variant (qNTT)."""

from qrisp.alg_primitives.arithmetic.jasp_arithmetic.jasp_mod_tools import modinv, smallest_power_of_two
