...
"""Computes carries via a Brent-Kung tree for the quantum-quantum carry-lookahead adder (QCLA)."""
...
# The cancellation of the brent kung tree at an early layer produce many GENERATE
...
def qq_calc_carry(a, b, radix_base=2, radix_exponent=0):
    ...
    # DAG disappears. This introduces two extra CNOT gates per iteration. However,
