...
class LinearCombinationBlockEncoding(BlockEncoding):
    ...
    def _make_lcu_branch(
        ...
        # qache carries this name onto the jit equation it emits, so the traced
        # program names the term each branch came from instead of repeating
        # "branch". It plays no part in the caching, which is keyed on the branch
        # object itself.
