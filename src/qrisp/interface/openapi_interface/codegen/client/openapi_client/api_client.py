...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.ping  # this is an instance of the class Endpoint
        api_instance.ping()  # this invokes api_instance.ping.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.ping.callable or self.callable in this class
