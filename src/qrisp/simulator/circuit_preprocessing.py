...
before they are dispatched to a backend. It features a Dual-Path Numba compiler 
that vectorizes qubit bitmasks into chunks to bypass 64-bit memory limitations 
on massive statevector simulations.
================================================================================
"""
