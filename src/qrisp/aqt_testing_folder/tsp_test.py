...
from qrisp.algorithms.grover import grovers_alg
...
print(qc.cnot_count())
print(qc.num_qubits())
print(sum([val for val in qc.transpile().count_ops().values()]))
...
res = multi_measurement(perm_specifiers, backend = example_backend)
