...
from qrisp.algorithms.qaoa import create_maxcut_cost_operator, RX_mixer, QAOAProblem, create_maxcut_cl_cost_function
...
res = maxcut_instance.run(qarg, depth, mes_kwargs={"backend" : example_backend}, max_iter = 50) # runs the simulation
